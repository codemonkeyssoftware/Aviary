...
if ($ok) {
	...
	if ($comments_notify) {
		...
		$notify_message = "New comment onyour post #$comment_post_ID " .stripslashees($postdata['Title']) . "\r\n\r\n";
